...
import (
	...
	apiresourcev1alpha1listers "github.com/kcp-dev/contrib-tmc/client/listers/apiresource/v1alpha1"
)

const clusterNameAndGVRIndexName = "clusterNameAndGVR"
const ControllerName = "tmc-apiresource"
...
func NewController(
	...
	queue := workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "tmc-apiresource")
