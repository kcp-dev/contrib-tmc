...
func (o *CordonOptions) Run(ctx context.Context) error {
	...
	syncTarget, err := tmcClient.WorkloadV1alpha1().SyncTargets().Get(ctx, o.SyncTarget, metav1.GetOptions{})
	if err != nil {
	...
	_, err = tmcClient.WorkloadV1alpha1().SyncTargets().Patch(ctx, o.SyncTarget, types.JSONPatchType, patchBytes, metav1.PatchOptions{})
	if err != nil {
