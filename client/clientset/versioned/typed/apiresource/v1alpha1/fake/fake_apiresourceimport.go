...
func (c *FakeAPIResourceImports) Apply(ctx context.Context, aPIResourceImport *apiresourcev1alpha1.APIResourceImportApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.APIResourceImport, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apiresourceimportsResource, *name, types.ApplyPatchType, data), &v1alpha1.APIResourceImport{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.APIResourceImport), err
...
func (c *FakeAPIResourceImports) ApplyStatus(ctx context.Context, aPIResourceImport *apiresourcev1alpha1.APIResourceImportApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.APIResourceImport, err error) {
	if aPIResourceImport == nil {
		return nil, fmt.Errorf("aPIResourceImport provided to Apply must not be nil")
	}
	data, err := json.Marshal(aPIResourceImport)
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apiresourceimportsResource, *name, types.ApplyPatchType, data, "status"), &v1alpha1.APIResourceImport{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.APIResourceImport), err
