...
func (f *locationClusterInformer) Lister() schedulingv1alpha1listers.LocationClusterLister {
	return schedulingv1alpha1listers.NewLocationClusterLister(f.Informer().GetIndexer())
}
